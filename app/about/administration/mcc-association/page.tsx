...
const sidebarLinks = [
  { label: "MCC Association", href: "/about/administration/mcc-association", active: true },
...
const officeBearers = [
  ...
  { role: "Principal & Secretary, MCC", name: "Dr P. Wilson" },
  { role: "Treasurer, MCC Association", name: "Mr Cyrus Kallupurackal" },
];

const HONORIFICS = [
  "Rt Rev Dr", "Prof Dr", "Dr Mrs", "Rev Dr",
...
export default function MCCAssociationPage() {
  return (
    <>
      <Navbar />
        ...
        <div className="max-w-[1200px] mx-auto px-6 w-full">
          <nav className="mb-4">
            <ol className="flex items-center gap-2 font-dm text-[12px] tracking-wide">
              ...
              <li className="text-white/40">/</li>
              <li className="text-gold">MCC Association</li>
            </ol>
          </nav>
          <h1
        ...
        <div className="max-w-[1200px] mx-auto px-6 flex gap-8 items-start py-10">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div style={{ padding: "30px 0 24px" }}>
              ...
              >
                MCC Association Members
              </h2>
              <div style={{ width: "50px", height: "2px", backgroundColor: "#D1B05D", marginBottom: "20px" }} />
              <p
                className="font-cormorant text-[#444444]"
                style={{ fontSize: "18px", lineHeight: "1.9", maxWidth: "680px", marginBottom: "14px" }}
              >
                The MCC Association comprises distinguished members committed to guiding Madras
                Christian College towards academic excellence and social responsibility.
              </p>
              <p
                className="font-cormorant italic text-[#888]"
                style={{ fontSize: "15px" }}
              >
