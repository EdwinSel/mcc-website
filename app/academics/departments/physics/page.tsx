...
import { Target, GraduationCap, BookMarked } from "lucide-react";
...
const faculty: FacultyMember[] = [
  { name: "S. Karthikeyan",           designation: "Assistant Professor",    email: "karthikeyan@mcc.edu.in",      photo: "/images/faculty/physics/karthikeyan.jpg", initials: "SK" },
  { name: "J. Joseph Jeremiah",       designation: "Assistant Professor",    email: "josephjeremiah@mcc.edu.in",   photo: "/images/faculty/physics/joseph.jpg",      initials: "JJ" },
  { name: "Larny Mary Jayan",         designation: "Assistant Professor",    email: "larnyjayan@mcc.edu.in",       photo: "/images/faculty/physics/larny.jpg",       initials: "LJ" },
  { name: "N. Nirmal Thyagu",         designation: "Assistant Professor",    email: "nirmalthyagu@mcc.edu.in",     photo: "/images/faculty/physics/nirmal.jpg",      initials: "NT" },
  { name: "Johanan Christian Prasana",designation: "Head of the Department", email: "jcprasana@mcc.edu.in",        photo: "/images/faculty/physics/johanan.jpg",     initials: "JC" },
  { name: "E. Caroline Victoria",     designation: "Assistant Professor",    email: "ecarolinevictoria@mcc.edu.in",photo: "/images/faculty/physics/caroline.jpg",    initials: "CV" },
  { name: "P. Subhashini",            designation: "Assistant Professor",    email: "subashini@mcc.edu.in",        photo: "/images/faculty/physics/subhashini.jpg",  initials: "PS" },
  { name: "R. Daniel",                designation: "Assistant Professor",    email: "rdaniel@mcc.edu.in",          photo: "/images/faculty/physics/daniel.jpg",      initials: "RD" },
  { name: "S. Janet Priscilla",       designation: "Assistant Professor",    email: "janetpriscilla@mcc.edu.in",   photo: "/images/faculty/physics/janet.jpg",       initials: "JP" },
  { name: "D. Selvakumari",           designation: "Assistant Professor",    email: "selvakumari@mcc.edu.in",      photo: "/images/faculty/physics/selvakumari.jpg", initials: "DS" },
  { name: "M. Rabikumar",             designation: "Assistant Professor",    email: "rabikumar@mcc.edu.in",        photo: "/images/faculty/physics/rabikumar.jpg",   initials: "MR" },
  { name: "D. Joice Sheeba",          designation: "Assistant Professor",    email: "",                            photo: "/images/faculty/physics/joice.jpg",       initials: "JS" },
];
...
export default function PhysicsDeptPage() {
  return (
    <>
      <Navbar />
      ...
      >
        ...
        <nav>
          <ol className="flex items-center gap-2 font-dm text-[13px]" style={{ color: "rgba(255,255,255,0.6)" }}>
            ...
            <li>/</li>
            <li style={{ color: "#D1B05D" }}>Physics</li>
          </ol>
        </nav>
      </section>
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1, padding: "56px 24px 60px", textAlign: "center", borderRight: "1px solid #dfdfdf" }}>
            <Target size={55} color="#7B2C3A" style={{ margin: "0 auto" }} />
      ...
      <section style={{ backgroundColor: "white", padding: "60px 24px" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          <BodyText>
            The department of Physics was established in 1937, and it started offering M.Sc courses
            in 1958, Ph.D in 1977 and M.Phil in 1980. The department has sent forth a large number of
            leaders in whatever field they chose to excel in. The University courses of B.Sc., M.Sc.,
            and M.Phil are offered by the department under autonomy and in the CBCS pattern.
          </BodyText>
          <BodyText>
            Special optional papers on Material Science, Biophysics, Electronic Instrumentation,
            Nuclear Reactor Physics, Crystal Physics and Embedded Systems are offered in the various
            courses to suit the current trends in various academic and employment opportunities.
            Students are encouraged to gain research experience in the postgraduate courses. The
            Department has a well-stocked library and a state-of-the-art facility.
          </BodyText>
        </div>
      </section>
