...
import { Dog, GraduationCap, BookMarked } from "lucide-react";
...
const faculty: FacultyMember[] = [
  { name: "C. Joyce Priyakumari",        designation: "Head of the Department", email: "joycepriya@mcc.edu.in",       photo: "/images/faculty/zoology/joyce.jpg",   initials: "JP" },
  { name: "Ananthi Rachel Livingstone",  designation: "Assistant Professor",    email: "ananthirachel@mcc.edu.in",    photo: "/images/faculty/zoology/ananthi.jpg", initials: "RL" },
  { name: "J. Logamanya Tilak",          designation: "Assistant Professor",    email: "tilak@mcc.edu.in",             photo: "/images/faculty/zoology/tilak.jpg",   initials: "LT" },
  { name: "Allen J. Freddy",             designation: "Assistant Professor",    email: "allenjfreddy@mcc.edu.in",      photo: "/images/faculty/zoology/allen.jpg",   initials: "AF" },
  { name: "Adline Jennefa Daniel",       designation: "Assistant Professor",    email: "adlinedaniel@mcc.edu.in",      photo: "/images/faculty/zoology/adline.jpg",  initials: "AD" },
  { name: "Anulin Christudhas",          designation: "Assistant Professor",    email: "anulinchristudhas@mcc.edu.in", photo: "/images/faculty/zoology/anulin.jpg",  initials: "AC" },
  { name: "M. Akila",                    designation: "Assistant Professor",    email: "akilam@mcc.edu.in",            photo: "/images/faculty/zoology/akila.jpg",   initials: "MA" },
  { name: "P. Lalitha Lavanya",          designation: "Assistant Professor",    email: "lalithalavanya@mcc.edu.in",    photo: "/images/faculty/zoology/lalitha.jpg", initials: "LL" },
  { name: "K. Sunil Kumar",              designation: "Assistant Professor",    email: "ksunilkumar@mcc.edu.in",       photo: "/images/faculty/zoology/sunil.jpg",   initials: "SK" },
];
...
export default function ZoologyDeptPage() {
  return (
    <>
      <Navbar />
      ...
      >
        ...
        <nav>
          <ol className="flex items-center gap-2 font-dm text-[13px]" style={{ color: "rgba(255,255,255,0.6)" }}>
            ...
            <li>/</li>
            <li style={{ color: "#D1B05D" }}>Zoology</li>
          </ol>
        </nav>
      </section>
      ...
      >
        ...
        >
          ...
          <div style={{ flex: 1, padding: "56px 24px 60px", textAlign: "center", borderRight: "1px solid #dfdfdf" }}>
            <Dog size={55} color="#7B2C3A" style={{ margin: "0 auto" }} />
      ...
      <section style={{ backgroundColor: "white", padding: "60px 24px" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          <BodyText>
            The Department of Zoology was established in 1885 and is one of the oldest centers of
            higher education in Southern India. Areas of specialization include Animal Behaviour,
            Aquaculture, Endocrinology, Entomology and Fisheries Science. Innovative subjects such
            as Bio-technology, Molecular Biology, Immunology and Biochemistry are offered both at
            Undergraduate and Postgraduate levels. Number of sophisticated instruments are available
            in the laboratory. The Estuarine Biological Laboratory at Pulicat is a research centre
            of the department.
          </BodyText>
        </div>
      </section>
