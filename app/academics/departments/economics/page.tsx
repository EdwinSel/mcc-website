...
const faculty: FacultyMember[] = [
  { name: "D. Merlin Juliet Arul Thangam", designation: "Assistant Professor", email: "merlinjuliet@mcc.edu.in",      photo: "/images/faculty/economics/merlin.jpg",      initials: "MJ" },
  { name: "S. Adeline",                    designation: "Assistant Professor", email: "adeline@mcc.edu.in",           photo: "/images/faculty/economics/adeline.jpg",     initials: "SA" },
  { name: "A. Annadurai",                  designation: "Assistant Professor", email: "annadurai@mcc.edu.in",         photo: "/images/faculty/economics/annadurai.jpg",   initials: "AA" },
  { name: "Arun Koshy",                    designation: "Assistant Professor", email: "arunkoshy@mcc.edu.in",         photo: "/images/faculty/economics/arun.jpg",        initials: "AK" },
  { name: "Ruth Elizabeth Jacob",          designation: "Assistant Professor", email: "ruth@mcc.edu.in",              photo: "/images/faculty/economics/ruth.jpg",        initials: "RJ" },
  { name: "S. Ramakrishnan",               designation: "Assistant Professor", email: "ramakrishnan@mcc.edu.in",      photo: "/images/faculty/economics/ramakrishnan.jpg",initials: "SR" },
  { name: "Shobana Karthikeyan",           designation: "Assistant Professor", email: "shobanakarthikeyan@mcc.edu.in",photo: "/images/faculty/economics/shobana.jpg",     initials: "SK" },
  { name: "S. Sagathevan",                 designation: "Assistant Professor", email: "s.sagathevan@mcc.edu.in",      photo: "/images/faculty/economics/sagathevan.jpg",  initials: "SS" },
];
...
export default function EconomicsDeptPage() {
  return (
    <>
      <Navbar />
      ...
      >
        ...
        <nav>
          <ol className="flex items-center gap-2 font-dm text-[13px]" style={{ color: "rgba(255,255,255,0.6)" }}>
            ...
            <li>/</li>
            <li style={{ color: "#D1B05D" }}>Economics</li>
          </ol>
        </nav>
      </section>
      ...
      >
        ...
        >
          ...
          <div className="w-full md:flex-1 p-6 md:p-10 text-center border-b md:border-b-0 md:border-r border-[#dfdfdf]">
            <TrendingUp size={55} color="#7B2C3A" style={{ margin: "0 auto" }} />
      ...
      <section className="px-4 py-8 md:px-6 md:py-[60px]" style={{ backgroundColor: "white" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          <BodyText>
            The Department of Economics is one of the oldest Departments in the College. The department
            of Economics has distinguished itself to be one of the leading centres of learning economics
            in the country. India&apos;s first three Finance Ministers and leading economists are among
            its Alumni.
          </BodyText>
          <BodyText>
            The Department has developed a unique and challenging curriculum and syllabus at the
            Undergraduate and Postgraduate levels. Students are trained to analyze concrete problems
            with the help of conceptual frames, theoretical insights and mathematical, statistical and
            econometric tools along with computer applications. Areas of specialization include
            Development Economics, Environmental Economics, Econometrics, Mathematical Economics,
            Money and Finance, Institutional Economics, Micro and Macro studies.
          </BodyText>
          <BodyText>
            As a postgraduate and research department with enviable legacy of illustrious teachers and
            alumni for more than a century it has carved a niche for itself as a centre of learning in
            which economics is taught with a difference. It has the honour of having initiated an active
            discussion on the new approach to economics curriculum and the subject of &apos;teaching
            economics&apos; in an ongoing exercise among the faculty of economics. It is a matter of
            great satisfaction that students and faculty act in unison to make the teaching-learning
            process a highly purposeful mission.
          </BodyText>
        </div>
      </section>
